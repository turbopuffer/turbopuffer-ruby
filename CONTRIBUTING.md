...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/turbopuffer/helpers/` and `examples/` directory.
...
require_relative "../lib/turbopuffer"
...
```ruby
gem "turbopuffer-ruby", git: "https://www.github.com/turbopuffer/turbopuffer-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/turbopuffer/turbopuffer-ruby' '<path-to-repo>'
```

```ruby
gem "turbopuffer-ruby", path: "<path-to-repo>"
```
