...
```ruby
gem "turbopuffer", git: "https://www.github.com/stainless-sdks/turbopuffer-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/turbopuffer-ruby' '<path-to-repo>'
```

```ruby
gem "turbopuffer", path: "<path-to-repo>"
```
