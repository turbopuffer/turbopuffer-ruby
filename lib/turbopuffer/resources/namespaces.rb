...
module Turbopuffer
  module Resources
    class Namespaces
      ...
      #
      # @param compute_attributes [Hash{Symbol=>Turbopuffer::Models::ComputeAttributes}] Body param: Computes additional values on documents returned by a query. Each ke
      #
