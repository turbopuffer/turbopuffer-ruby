  ...
  module Models
    ...
    class NamespaceExplainQueryParams < Turbopuffer::Internal::Type::BaseModel
      ...
      optional :compute_attributes,
               -> { Turbopuffer::Internal::Type::HashOf[union: Turbopuffer::NamespaceExplainQueryParams::ComputeAttribute] }
      ...
      module ComputeAttribute
        ...
        variant -> { Turbopuffer::Models::NamespaceExplainQueryParams::ComputeAttribute::RankByAttributeArray }
