      ...
      class BaseClient
          ...
          T.type_alias do
            {
              ...
              page:
                T.nilable(
                  T::Class[
                    Turbopuffer::Internal::Type::BasePage[
        ...
        class << self
          ...
          sig do
            params(
              request:
                Turbopuffer::Internal::Transport::BaseClient::RequestInput,
              status: Integer,
          ...
          sig do
            params(
              status: T.any(Integer, Turbopuffer::Errors::APIConnectionError),
        ...
        # @api private
        sig { returns(Turbopuffer::Internal::Transport::PooledNetRequester) }
        ...
        sig do
          overridable
            .params(
              req:
                Turbopuffer::Internal::Transport::BaseClient::RequestComponents,
              opts: Turbopuffer::Internal::AnyHash
            )
            .returns(Turbopuffer::Internal::Transport::BaseClient::RequestInput)
        end
        ...
        sig do
          params(
            request: Turbopuffer::Internal::Transport::BaseClient::RequestInput,
