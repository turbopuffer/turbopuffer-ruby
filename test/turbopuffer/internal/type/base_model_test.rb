...
class Turbopuffer::Test::PrimitiveModelTest < Minitest::Test
  A = Turbopuffer::Internal::Type::ArrayOf[-> { Integer }]
  H = Turbopuffer::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Turbopuffer::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Turbopuffer::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Turbopuffer::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Turbopuffer::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Turbopuffer::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        Turbopuffer::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Turbopuffer::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Turbopuffer::Internal::Type::Boolean, true] => true,
      [Turbopuffer::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Turbopuffer::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Turbopuffer::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Turbopuffer::Internal::Type::Converter.new_coerce_state
      Turbopuffer::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Turbopuffer::Internal::Type::Converter.dump(target, input, state: state)
...
class Turbopuffer::Test::EnumModelTest < Minitest::Test
  class E0
    include Turbopuffer::Internal::Type::Enum
    attr_reader :values
...
class Turbopuffer::Test::CollectionModelTest < Minitest::Test
  A1 = Turbopuffer::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Turbopuffer::Internal::Type::HashOf[Integer]

  A2 = Turbopuffer::Internal::Type::ArrayOf[H1]
  H2 = Turbopuffer::Internal::Type::HashOf[-> { A1 }]

  A3 = Turbopuffer::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Turbopuffer::Internal::Type::HashOf[Integer, nil?: true]
...
class Turbopuffer::Test::BaseModelTest < Minitest::Test
  class M1 < Turbopuffer::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Turbopuffer::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Turbopuffer::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Turbopuffer::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Turbopuffer::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Turbopuffer::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Turbopuffer::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Turbopuffer::Errors::ConversionError => e
...
class Turbopuffer::Test::UnionTest < Minitest::Test
  class U0
    include Turbopuffer::Internal::Type::Union
  ...
  class M2 < Turbopuffer::Internal::Type::BaseModel
  ...
  class M4 < Turbopuffer::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Turbopuffer::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Turbopuffer::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Turbopuffer::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Turbopuffer::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Turbopuffer::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [Turbopuffer::Internal::Type::Unknown, Turbopuffer::Internal::Type::Unknown] => true,
      [Turbopuffer::Internal::Type::Boolean, Turbopuffer::Internal::Type::Boolean] => true,
      [Turbopuffer::Internal::Type::Unknown, Turbopuffer::Internal::Type::Boolean] => false,
...
class Turbopuffer::Test::MetaInfoTest < Minitest::Test
  A1 = Turbopuffer::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Turbopuffer::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
