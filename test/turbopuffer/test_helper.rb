...
class Turbopuffer::Test::SingletonClient < Turbopuffer::Client
  include Singleton
...
class Turbopuffer::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @turbopuffer = Turbopuffer::Test::SingletonClient.instance
  end
