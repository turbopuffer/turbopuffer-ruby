  ...
  def test_metadata_required_params
    ...
    assert_pattern do
      response => {
        ...
        created_at: Time,
        encryption: Turbopuffer::Encryption,
  ...
  def test_query_required_params
    ...
    assert_pattern do
      response => {
        billing: Turbopuffer::QueryBilling,
        performance: Turbopuffer::QueryPerformance,
        aggregation_groups: ^(Turbopuffer::Internal::Type::ArrayOf[Turbopuffer::Internal::Type::HashOf[Turbopuffer::Internal::Type::Unknown]]) | nil,
